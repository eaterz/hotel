            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->usertype == 'admin')
                        ...
                        <x-nav-link href="/admin/room" :active="request()->routeIs('admin.room')">
                            {{ __('Room') }}
                        </x-nav-link>

                        <x-nav-link href="/admin/reserve" :active="request()->routeIs('admine.reserve')">
                            {{ __('Reserve') }}
                        </x-nav-link>
                    ...
                    @if (Auth::user()->usertype == 'user')
                        ...
                        <x-nav-link href="/room" :active="request()->routeIs('user.room')">
                            {{ __('Room') }}
                        </x-nav-link>

                        <x-nav-link href="/reserve" :active="request()->routeIs('user.reserve')">
                            {{ __('My rooms') }}
                        </x-nav-link>
